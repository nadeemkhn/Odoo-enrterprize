...
class TestAccountAsset(TestAccountReportsCommon):
    ...
    def test_depreciation_schedule_report_with_imported_amount_asset(self):
        ...
        for year in ['2020', '2021', '2022', '2023', '2024', '2025']:
            ...
            line = report._get_lines({**options, 'unfold_all': False, 'all_entries': True})[2]['columns']
            if not first_depreciation_date:
                first_depreciation_date = line[1]['no_format']
            line = [round(column['no_format'], 2) for column in line[8:]]
            lines.append(line)
        ...
        self.assertEqual(first_depreciation_date, '12/31/2020')
